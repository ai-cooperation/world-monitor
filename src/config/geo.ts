...
export const INTEL_HOTSPOTS: Hotspot[] = [
  ...
  // APAC Expansion
  {
    ...
    subtext: 'SCS Disputes',
    lat: 12.0,
    lon: 114.0,
    location: 'South China Sea',
    keywords: ['south china sea', 'spratlys', 'paracels', 'nine-dash line', 'scarborough', 'whitsun reef', 'second thomas shoal', 'ayungin', 'west philippine sea'],
    agencies: ['PLA Navy', 'Philippine Navy', 'Vietnam Coast Guard', 'AMTI'],
    description: 'Contested maritime territory. Chinese militarization of artificial islands. Philippine-China standoffs.',
    status: 'Monitoring',
    escalationScore: 4,
    escalationTrend: 'escalating',
    escalationIndicators: ['China coast guard water cannon attacks', 'Philippine resupply missions contested', 'Artificial island militarization', 'UNCLOS ruling ignored'],
    history: {
      lastMajorEvent: 'Second Thomas Shoal confrontation',
      lastMajorEventDate: '2024-06-17',
      precedentCount: 5,
      precedentDescription: 'Scarborough standoff 2012, UNCLOS ruling 2016, Whitsun Reef 2021, ongoing BRP Sierra Madre resupply disputes',
      cyclicalRisk: 'Fishing season bans (May-Aug) create friction',
    },
    whyItMatters: '$5.3 trillion annual trade flows; 80% of China oil imports transit here; test case for rules-based order',
  },
  {
    id: 'east_china_sea',
    name: 'East China Sea',
    subtext: 'Senkaku/Diaoyu',
    lat: 28.0,
    lon: 126.0,
    location: 'East China Sea',
    keywords: ['east china sea', 'senkaku', 'diaoyu', 'adiz', 'okinawa', 'first island chain'],
    agencies: ['JASDF', 'PLA Air Force', 'Japan Coast Guard'],
    description: 'Disputed Senkaku/Diaoyu Islands. Chinese ADIZ incursions. First Island Chain tensions.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable',
    escalationIndicators: ['Record PLA ADIZ incursions', 'Japan defense budget doubling', 'Coast guard confrontations', 'JASDF scrambles increasing'],
    whyItMatters: 'Potential US-China flashpoint under US-Japan security treaty; first island chain defense strategy',
  },
  {
    ...
    keywords: ['myanmar', 'burma', 'junta', 'tatmadaw', 'pdf', 'nug', 'rohingya', 'rakhine', 'shan', 'kachin', 'operation 1027'],
    agencies: ['Tatmadaw', 'NUG/PDF', 'Ethnic Armed Orgs'],
    description: 'Multi-front civil war since 2021 coup. Resistance forces gaining territory. Humanitarian crisis.',
    status: 'Monitoring',
    escalationScore: 4,
    escalationTrend: 'escalating',
    escalationIndicators: ['Operation 1027 resistance offensive', 'Junta losing border territories', 'China mediating ceasefires', 'Conscription law enacted'],
    history: {
      lastMajorEvent: 'Operation 1027 launched',
      lastMajorEventDate: '2023-10-27',
      precedentCount: 4,
      precedentDescription: '2021 coup, decades of ethnic conflicts, 1988 uprising, Rohingya crisis 2017',
      cyclicalRisk: 'Dry season offensives (Nov-Apr)',
    },
    whyItMatters: 'Regional refugee crisis; China-India buffer state; drug production hub; democratic aspirations vs military rule',
  },
  {
    id: 'seoul',
    name: 'Seoul',
    ...
    keywords: ['seoul', 'south korea', 'rok', 'korean peninsula', 'yoon', 'martial law', 'k-defense'],
    agencies: ['ROK Military', 'NIS', 'USFK'],
    description: 'Korean Peninsula tensions. North Korea provocations. US-ROK alliance dynamics.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable',
    escalationIndicators: ['DPRK missile tests', 'Russia-DPRK military cooperation', 'Domestic political crisis', 'USFK readiness'],
    whyItMatters: 'DPRK nuclear threat; semiconductor supply chain; US alliance credibility; domestic political instability',
  },
  {
    id: 'asean_hub',
    name: 'Singapore',
    ...
    keywords: ['asean', 'singapore', 'southeast asia', 'malacca', 'indo-pacific', 'rcep'],
    agencies: ['ASEAN Secretariat', 'Shangri-La Dialogue'],
    description: 'ASEAN diplomatic hub. Malacca Strait security. Indo-Pacific strategic nexus.',
    status: 'Monitoring',
    escalationScore: 2,
    whyItMatters: 'Malacca Strait handles 25% of global trade; ASEAN centrality in great power competition; RCEP economic bloc',
  },
  {
    id: 'hsinchu',
    name: 'Hsinchu',
    subtext: 'Semiconductor Valley',
    lat: 24.8,
    lon: 120.97,
    location: 'Hsinchu Science Park, Taiwan',
    keywords: ['tsmc', 'semiconductor', 'hsinchu', 'chip', 'foundry', 'silicon shield', 'advanced packaging'],
    agencies: ['TSMC', 'UMC', 'MediaTek', 'ITRI'],
    description: 'Global semiconductor manufacturing center. TSMC produces 90%+ of advanced chips.',
    status: 'Monitoring',
    escalationScore: 3,
    whyItMatters: 'Single point of failure for global chip supply; "silicon shield" deterrence theory; $600B+ industry concentration',
  },
];
