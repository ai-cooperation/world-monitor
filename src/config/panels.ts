...
const FULL_PANELS: Record<string, PanelConfig> = {
  // ── Tier 1: Panels with confirmed working data ──
  ...
  displacement: { name: 'UNHCR Displacement', enabled: true, priority: 1 },
  climate: { name: 'Climate Anomalies', enabled: true, priority: 1 },
  'satellite-fires': { name: 'Fires', enabled: true, priority: 1 },
  'security-advisories': { name: 'Security Advisories', enabled: true, priority: 1 },
  ...
  // ── Tier 2: RSS-dependent panels (may load slowly) ──
  'live-news': { name: 'Live News', enabled: true, priority: 2 },
  intel: { name: 'Intel Feed', enabled: true, priority: 2 },
  'gdelt-intel': { name: 'Live Intelligence', enabled: true, priority: 2 },
  ...
  us: { name: 'United States', enabled: true, priority: 2 },
  europe: { name: 'Europe', enabled: true, priority: 2 },
  africa: { name: 'Africa', enabled: true, priority: 2 },
  latam: { name: 'Latin America', enabled: true, priority: 2 },
  ...
  // ── Tier 3: Panels needing extra API keys or limited data ──
  insights: { name: 'AI Insights', enabled: true, priority: 2 },
  'strategic-posture': { name: 'AI Strategic Posture', enabled: true, priority: 2 },
